...
> [Algorithms](https://github.com/williamfiset/Algorithms) Java实现的算法库
...
> [Disjoint Set Union Data Structure | Baeldung on Computer Science](https://www.baeldung.com/cs/disjoint-set-union-data-structure)  
> [java - 并查集算法 - Algorithms, Part I, week 1 UNION-FIND - COURSERA-算法公开课-普林斯顿 - SegmentFault 思否](https://segmentfault.com/a/1190000018282413)  
*********************
## 匹配算法
**字符串相似度**
...
- 余弦相似度 > [使用余弦相似度算法计算文本相似度 - 广告流程自动化](https://geek.digiasset.org/pages/nlp/nlpinfo/cosine-similarity-algorithm2calculate-text-similarity/)  

**向量相似度**

欧氏距离，余弦相似度，修正余弦相似度

[向量相似度计算方法 | 沙舟的博客](https://sandship.fun/post/1d51.html)  
