...
[Go 实现](/Go/GoBase.md#协程) | [Kotlin 实现](/Kotlin/KotlinBase.md#协程) | [Python 实现](/Python/PythonConcurrency.md#协程-asyncio) | [Java 实现](/Java/AdvancedLearning/JavaThread.md#协程)

把 Erlang 放在这里有点降维打击，因为它的协程被称为 “轻量级进程（Process）”，是 Actor 模型的鼻祖。
