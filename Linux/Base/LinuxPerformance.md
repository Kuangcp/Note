...
- 7. [进程管理](#进程管理)
    ...
    - 7.8. [pstree](#pstree)
    - 7.9. [kill](#kill)
    - 7.10. [killall](#killall)
    - 7.11. [trap](#trap)
    - 7.12. [作业控制](#作业控制)
    - 7.13. [守护进程](#守护进程)
        - 7.13.1. [nohup](#nohup)
        - 7.13.2. [disown](#disown)
        - 7.13.3. [setid](#setid)
        - 7.13.4. [screen](#screen)
    - 7.14. [IPC](#ipc)
- 8. [系统管理](#系统管理)
    - 8.1. [uname](#uname)
    - 8.2. [who](#who)
...
# 内存情况
对于Linux来说, 都是有内存就去分配使用, 只有内存不够了才会去回收, 对于服务器来说, 交换内存会带来性能的明显下降 一般是不会配置的  
