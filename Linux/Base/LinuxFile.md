...
- 1. [文件管理](#文件管理)
    - 1.1. [查找文件](#查找文件)
        ...
        - 1.1.2. [fzf](#fzf)
        - 1.1.3. [locate](#locate)
        - 1.1.4. [Anything](#anything)
        - 1.1.5. [Synapse](#synapse)
    - 1.2. [查看文件](#查看文件)
        - 1.2.1. [stat](#stat)
        - 1.2.2. [file](#file)
        - 1.2.3. [tree](#tree)
...
- 2. [磁盘](#磁盘)
    - 2.1. [文件系统](#文件系统)
        - 2.1.1. [Tmpfs](#tmpfs)
        - 2.1.2. [fsck](#fsck)
    - 2.2. [安装系统时基本分区](#安装系统时基本分区)
    - 2.3. [设备列表](#设备列表)
    - 2.4. [常用命令](#常用命令)
        - 2.4.1. [dd](#dd)
        - 2.4.2. [truncate](#truncate)
        - 2.4.3. [mount](#mount)
        - 2.4.4. [fdisk](#fdisk)
        - 2.4.5. [df](#df)
        - 2.4.6. [du](#du)
...
- 4. [文件共享](#文件共享)
    - 4.1. [Samba](#samba)
        - 4.1.1. [搭建匿名Samba服务器](#搭建匿名samba服务器)
- 5. [Tips](#tips)
    - 5.1. [设置交换内存文件](#设置交换内存文件)
        - 5.1.1. [清空交换内存](#清空交换内存)
    - 5.2. [清除缓存](#清除缓存)
    - 5.3. [善用*shrc文件](#善用shrc文件)
