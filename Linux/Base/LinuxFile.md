...
- 4. [磁盘](#磁盘)
    - 4.1. [文件系统](#文件系统)
        - 4.1.1. [Tmpfs](#tmpfs)
        - 4.1.2. [fsck](#fsck)
    - 4.2. [安装系统时基本分区](#安装系统时基本分区)
    - 4.3. [设备列表](#设备列表)
    - 4.4. [常用命令](#常用命令)
        - 4.4.1. [dd](#dd)
        - 4.4.2. [truncate](#truncate)
        - 4.4.3. [mount](#mount)
        - 4.4.4. [fdisk](#fdisk)
        - 4.4.5. [df](#df)
        - 4.4.6. [du](#du)
...
- 6. [文件共享](#文件共享)
    - 6.1. [Samba](#samba)
        - 6.1.1. [搭建匿名Samba服务器](#搭建匿名samba服务器)
- 7. [Tips](#tips)
    - 7.1. [设置交换内存文件](#设置交换内存文件)
        - 7.1.1. [清空交换内存](#清空交换内存)
    - 7.2. [清除缓存](#清除缓存)
    - 7.3. [善用*shrc文件](#善用shrc文件)
...
同步和异步的概念描述的是用户线程与内核的交互方式 阻塞和非阻塞的概念描述的是用户线程调用内核IO操作的方式
